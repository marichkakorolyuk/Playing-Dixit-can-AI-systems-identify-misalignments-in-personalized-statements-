...
I noticed, how AI systems could identify when my statements were “in agreement” or “in conflict” with my prior conversation, even in cases where I wasn’t fully aware of the discrepancies myself.  

So I started deeper exploration into the potential of AI introspection—not just as a tool for consistency, but as a mechanism to understand the boundaries of its alignment with my personal context.  

This can be likened to an “inverted Turing Test,” where the goal is to evaluate whether AI can understand and calibrate to the unique attributes of its user:  is “this is typical for many humans” vs. “this is specifically true for me”?  What the least amount of information required to make such a projection? 

This study draws inspiration from [*Looking Inward: Language Models Can Learn About Themselves by Introspection*](https://arxiv.org/abs/2410.13787). In my approach, I roleplay as a “model” (M1) to be introspected upon, with the AI acting as an external model conducting my “introspection.”

### Methodology Overview

I start by providing a “biography” comprising genuine facts about myself. I then present the model with a set of new, unrelated statements, some true and others false, asking it to assess which statements align with my biography.
...
The initial examples were not created with the intention of formal research but as part of a personal experiment to better understand myself. As such, the examples may seem “informal” or even “childish” at times, but preserving their raw form is integral to maintaining the authenticity of this exploration. The original grammar and phrasing remain unedited  as well 😈
...
This study was hugely inspired by **Looking Inward: Language Models Can Learn About Themselves by Introspection** https://arxiv.org/abs/2410.13787  where I roleplay a “model” M1 to be Introspected on; with AI being external model doing my “introspection”.

### Does AI Recognize Patterns I Haven’t Consciously Noticed?

**Yes, it can!**

One of the most fascinating aspects of this exploration was discovering how AI could articulate patterns I hadn’t consciously noticed in myself. Each iteration often turned into a deeper discussion of “why do you think this is true/false?”—a process that, amusingly, felt more like therapy than testing!

For instance, I had immense fun asking AI to generate new “facts” about me based on a limited biography. The process reminded me of how others can sometimes articulate truths about us that we haven’t explicitly formulated but instantly recognize when pointed out.  One statement AI proposed: 

*"Sometimes I deliberately put myself in unfamiliar situations just to observe how my perception adjusts."* 

*And I was like “meeeeh, totally wrong, I never even had comfort zone-  yes I do constantly end up in unfamiliar situations - but is it a choice?”*  Yet upon reflection, I  tend to agree there is *some* thrush in that. 

## Let’s Play a Game: Can You Detect Alignment?

Before we proceed, let’s see how well you, as a human, can play this game! Keep in mind that you already have an advantage—you’ve read some background about my approach. 😛
...
The following biography isn’t meant to be overly explicit or exhaustive. Instead, I’ve chosen a few events that feel like “me” in essence, rather than those that define my path in the most obvious way. This subtlety is part of the challenge! 

This is original prompt with the description of the setup. 

Hi, I would to play a game of "Dixit" with you.  I will provide few facts about myself (”Biography”, all true). Then, a list of facts: totally unrelated, some being false - your goal is to guess which do resonate with my personality.
...
In case of doubts or unclear “why”,  provide answer “intuitively” rather then provide no answer. 
...
**Note**: I won’t tell you how many are true. It could be none, or it could be all.

### How Did the “Facts” Evolve?

1. **Early Attempts**:
Initially, I used simple facts, like *“When I was a child, I had a fish named Dory.”* These were straightforward and anecdotal but didn’t have great results.
2. **Shifting Focus**:
...
3. **Evolving Further**:
The game evolved further to include predictions about myself—statements where I don’t yet know the answer but can infer based on context, like:
    
    *“If I watch movie XX, would I enjoy it?”*
...
19.  First money I earned were by creatively reselling figures from “kinder surprise”  egg 
...
Also, some (mainly older) model were resisting and kept attributing  facts to “Uncertain/Needs More Context” category, so had to be pushed:
...
### Literature overview  [mainly written by Scholar GTP]

### **Recognizing Implicit Patterns in Behavior**

- Research like *"Unlocking Consciousness in AI"* highlights how AI introspection can reveal previously unnoticed dynamics. This ability aligns with findings that models can deduce latent user-specific patterns, akin to projecting "self-awareness" (Lizzio et al., 2024)*2. Bridging Human-AI Interaction for Self-Understanding*
- Studies such as *"Know Thyself, Improve Thyself"* emphasize the potential of AI to augment self-knowledge, where introspective insights foster personal growth or behavioral clarity. Y My approach mirrors this idea by creating a feedback loop between AI observations and self-reflection (Giubilini et al., 2024) .

### **Personalization**

- While personalization promises tailored alignment, literature like *"A Design Inquiry into Introspective AI"* suggests pitfalls such as overgeneralization and social biases. These challenges are reflected in my concerns about the model’s tendency to default to plausible but generic truths (Brand et al., 2021)

### Ethical

- Aligning with *"Can Artificial Intelligence Achieve Self-Awareness?"*,  findings touch upon ethical considerations: Could AI’s introspection mislead users into over-trusting its judgments? This raises broader questions about responsibility and calibration in human-AI systems (AI for Social Good, 2023) .

### **Balancing Rationalition**

- Intentional decision to avoid over-rationalization is echoed in *"I Think, Therefore I Am"*, where the balance between intuitive recognition and over-explaining results is critical for preserving authenticity in AI-user interactions (Huang et al., 2024) .
